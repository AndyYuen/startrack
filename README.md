# Spring-Boot CXF JAXWS StartrackService Demo

This example demonstrates use of Apache CXF with Spring Boot.
...
You can then use the host report to access the service:
    ...
    https://example1-myproject.example.com /service/StartrackService?wsdl
